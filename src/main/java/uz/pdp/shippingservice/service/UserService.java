...
public class UserService {
    ...
    public ApiResponse registerUser(UserRegisterDto userRegisterDto) throws FileUploadException {
...
//        }
    ...
    private User from(UserRegisterDto userRegisterDto, int verificationCode) throws FileUploadException {
